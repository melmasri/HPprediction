...
MODEL = 'affinity'                   # model type options {'full', 'distance', 'affinity'}
COUNT = FALSE                        # only needed to be FALSE for uncertainty subsetting by years

subDir = 'test-CV/'                      #sub-directory where the saved output and other results are desired, directory must be created
